...
class TransactionServiceTest {
    ...
    void handleTransaction_approvesValidTransaction_andSavesToBD() {
        when(mockStockHistoryRepo.findFirst1ByStockOrderByTimeDesc(any(Stock.class))).thenReturn(Optional.of(mockStockHistory));
        ...
        verify(mockStockHistoryRepo).findFirst1ByStockOrderByTimeDesc(mockStock);
    ...
    void handleTransaction_BuyThenSell() {
        ...
        verify(mockStockHistoryRepo, times(2)).findFirst1ByStockOrderByTimeDesc(mockStock);
    ...
    void handleTransaction_BuyThenSellTwo_FailsOnce() {
        ...
        verify(mockStockHistoryRepo, times(3)).findFirst1ByStockOrderByTimeDesc(mockStock);
...
//        verify(mockValidator).validate(samePropertyValuesAs(trader.buildPortfolio()), TraderPortfolio.class);
    ...
    void handleTransaction_rejectsInvalidTransaction_NonExistentStock_andDoesNotSaveToBD() {
        when(mockStockHistoryRepo.findFirst1ByStockOrderByTimeDesc(any(Stock.class))).thenReturn(Optional.empty());
        when(mockStockRepo.findById(anyString())).thenReturn(Optional.of(mockStock));
